  ...
  return (
    <footer className='bg-navy-900 text-white pt-16 pb-8'>
      <div className='container mx-auto px-4 grid md:grid-cols-3 gap-10'>
        ...
        <div>
          ...
          <ul className='space-y-3 text-sm text-gray-400'>
            <li className='flex gap-2'><Phone size={16} className='text-gold-400 shrink-0 mt-0.5'/> +593 XX XXX XXXX</li>
            <li className='flex gap-2'><Mail size={16} className='text-gold-400 shrink-0 mt-0.5'/> info@reinadelcisne.com</li>
      ...
      <div className='border-t border-navy-700 mt-10 pt-6 text-center text-xs text-gray-500'>
        © {new Date().getFullYear()} Inmobiliaria Reina del Cisne. Todos los derechos reservados.
      </div>
    </footer>
  )
}
